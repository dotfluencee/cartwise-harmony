          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {getLeavesForDate(selectedDate).length > 0 ? (
                        getLeavesForDate(selectedDate).map((leave) => (
                          <TableRow key={leave.id}>
                            ...
                            <TableCell className="text-right">
                              <div className="flex justify-end gap-2">
                                <Button variant="ghost" size="sm" onClick={() => handleViewLeave(leave)}>
                                ...
                                <Button
                                  ...
                                  disabled={leave.approval_status === 'approved'}
                                >
                                ...
                                <Button
                                  ...
                                  disabled={leave.approval_status === 'rejected'}
                                >
                                  <X className="h-4 w-4" />
                                </Button>
                                <Button variant="ghost" size="sm" className="text-red-600" onClick={() => handleDeleteLeave(leave)}>
                                  <Trash2 className="h-4 w-4" />
                                </Button>
                              </div>
                            </TableCell>
            ...
            <Card className="md:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  View and manage all worker leave requests.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ScrollArea>
              ...
              {selectedWorkerId && (
                <TableFooter>
                  ...
                  {workers.find(w => w.id === selectedWorkerId)?.payment_type === 'monthly' && (
                    <>
                      <TableRow>
                        <TableCell colSpan={2}>Working Days in Month</TableCell>
                        <TableCell>{getMonthlyWorkingDays(currentMonth)}</TableCell>
                        <TableCell colSpan={2}></TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell colSpan={2}>Approved Leave Days</TableCell>
                        <TableCell>{getMonthlyApprovedLeaveDays(selectedWorkerId, currentMonth)}</TableCell>
                        <TableCell colSpan={2}></TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell colSpan={2}>Salary After Leave Adjustment</TableCell>
                        <TableCell>₹{calculateMonthlySalaryAfterLeaves(selectedWorkerId, currentMonth).toFixed(2)}</TableCell>
                        <TableCell colSpan={2}></TableCell>
                      </TableRow>
                      <TableRow>
          ...
          {selectedLeave && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label>Worker</Label>
                  <p className="text-sm font-medium">{getWorkerNameById(selectedLeave.worker_id)}</p>
                </div>
                <div>
                  <Label>Date</Label>
                  <p className="text-sm font-medium">{selectedLeave.leave_date}</p>
                </div>
                <div>
                  <Label>Type</Label>
                  <p className="text-sm font-medium">{getLeaveTypeLabel(selectedLeave.leave_type)}</p>
                </div>
                <div>
                  <Label>Status</Label>
                  <div className="mt-1">
              ...
              <div>
                <Label>Reason</Label>
                <p className="text-sm mt-1 border p-2 rounded-md bg-gray-50 min-h-[60px]">
              ...
              <div className="flex justify-between">
                <Button
                  ...
                  disabled={selectedLeave.approval_status === 'approved'}
                >
                ...
                <Button
                  ...
                  disabled={selectedLeave.approval_status === 'rejected'}
                >
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setLeaveToDelete(selectedLeave);
                    setDeleteLeaveDialogOpen(true);
                  }}
                >
      ...
      <AlertDialog open={deleteLeaveDialogOpen} onOpenChange={setDeleteLeaveDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Are you sure?</AlertDialogTitle>
            <AlertDialogDescription>
              This will permanently delete this leave application.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
